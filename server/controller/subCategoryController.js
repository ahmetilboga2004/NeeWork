...
export const getSubCategory = async (req, res) => {
    try {
        ...
        console.log(error);
        res.status(500).json({
            error: "Alt Kategori bilgisi alınırken bir hata oluştu. Lütfen daha sonra tekrar deneyin!",
        });
    }
};
...
export const getAllSubCategory = async (req, res) => {
    try {
        ...
        console.log(user.id);
        const freelancer = await Freelancer.findOne({ userId: user.id });
        console.log(freelancer.categoryId);
        if (freelancer) {
        ...
        console.log(error);
        res.status(500).json({
            error: "Alt Kategoriler alınırken bir hata oluştu. Lütfen daha sonra tekrar deneyin!",
        });
    }
};
...
export const addBulkSubCategory = async (req, res) => {
    try {
        ...
        console.log(error);
        res.status(500).json({
            error: "Alt Kategoriler eklenirken bir hata oluştu. Lütfen daha sonra tekrar deneyin!",
        });
    }
};
...
export const updateSubCategory = async (req, res) => {
    try {
        ...
        console.log(error);
        res.status(500).json({
            error: "Allt KAtegori güncellenirken bir hata oluştu. Lütfen daha sonra tekrar deneyin",
        });
    }
};
...
export const deleteSubCategory = async (req, res) => {
    try {
        ...
        console.log(error);
        res.status(500).json({
            error: "Alt kategori silinirken bir hata oluştu. Lütfen daha sonra tekrar deneyin!",
        });
    }
};
