    ...
    <div class="mx-auto grid justify-items-center p-4">
        <div class="w-full lg:w-2/5">
            <div class="bg-white rounded-lg p-4 w-full flex items-center mb-4">
                <div>
                    <img
                        src="@/assets/images/logos/Untitled-1-01.svg"
                ...
                >
                    <div>
                        <label
                            ...
                            >E-Posta yada Kullanıcı Adı</label
                        >
                        <input
                            type="text"
                            name="email-username"
                            ...
                            placeholder="E-Postanızı yada Kullanıcı adınızı girin"
                            required
                        />
                        ...
                        <small class="text-red-600" v-if="serverErrors.username">
                    ...
                    <div>
                        ...
                        <small
                            class="text-red-600"
                            v-if="serverErrors.password || v$.$invalid === true"
                        ...
                        <div class="flex items-start">
                            <div class="flex items-center h-5">
                                <input
                                    ...
                                    type="checkbox"
                                    class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-2"
                                    required
                                />
                            </div>
                    ...
                    <div>
                        <button
                            ...
                            :class="
                                v$.$invalid === true ? 'bg-gray-50' : 'bg-colorYellow hover:bg-gold'
                            "
                            class="text-black focus:ring-2 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                        >
                            Giriş Yap
                        </button>
                    </div>
                    <p class="text-sm font-light text-gray-500">
                        Bir Hesabın yok mu?
                        <RouterLink :to="{ name: 'register' }" class="font-medium hover:underline"
                            >Kayıt Ol</RouterLink
                        >
                    </p>
                </form>
