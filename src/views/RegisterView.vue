...
const ifFreelancer = () => formDatas.role === 'freelancer'
    ...
    <div class="w-full lg:w-2/5">
      ...
      <div class="px-4 md:px-6 bg-white rounded-lg p-4">
        <template v-if="currentStep !== 3">
          <div
            id="sign-up-header"
            class="text-2xl md:text-3xl font-bold font-roboto text-gray-800 mb-2 py-4"
          >
            Kayıt Ol
          </div>
        </template>
          ...
          <template v-if="currentStep === 1">
            ...
            <ul class="grid col-span-2 w-full gap-6 mb-4">
              <li>
                ...
                >
                  <div class="block">
                    <div class="w-full text-lg font-semibold">Müşteri</div>
                  </div>
            ...
            <div class="col-span-2">
              <p class="text-sm font-light text-gray-500">
                ...
                <RouterLink :to="{ name: 'login' }" class="font-medium hover:underline"
                  >Giriş Yap
                </RouterLink>
              </p>
            </div>
          ...
          <template v-if="currentStep === 2">
            <div class="col-span-2">
              ...
              <template v-for="error in v$.name.$errors" :key="error.$uid">
                <small class="text-red-600" v-if="error.$validator == 'required'"
                  >Bu alan zorunlu</small
                >
                <small class="text-red-600" v-if="error.$validator == 'alpha'"
                  >sadece alfabetik karakter giriniz!</small
                >
                <small class="text-red-600" v-if="error.$validator == 'minLength'"
                  >En az 2 karakter giriniz!</small
                >
                <small class="text-red-600" v-if="error.$validator == 'maxLength'"
                  >En fazla 30 karakter giriniz!</small
                >
              </template>
            </div>
            <div class="col-span-2">
            ...
            <div v-if="formDatas.role === 'freelancer'" class="col-span-2">
              <label for="meslek" class="block mb-2 text-sm font-medium text-gray-900"
                >Meslek</label
              >
              <input
                type="text"
            ...
            <div class="col-span-2">
              ...
              <template v-for="error in v$.email.$errors" :key="error.$uid">
                <small class="text-red-600" v-if="error.$validator == 'required'"
                  >Bu alan zorunlu</small
                >
                <small class="text-red-600" v-if="error.$validator == 'email'"
                  >Email adresinizi kontrol ediniz!</small
                >
              </template>
            </div>
            <div class="col-span-2">
              <label for="kullanici-adi" class="block mb-2 text-sm font-medium text-gray-900"
                >Kullanıcı Adı</label
              >
              <input
                type="text"
              ...
              <template v-for="error in v$.username.$errors" :key="error.$uid">
                <small class="text-red-600" v-if="error.$validator == 'required'"
                  >Bu alan zorunlu</small
                >
                <small class="text-red-600" v-if="error.$validator == 'alphaNum'"
                  >sadece alfa numerik karakter giriniz!</small
                >
                <small class="text-red-600" v-if="error.$validator == 'minLength'"
                  >En az 4 karakter giriniz!</small
                >
                <small class="text-red-600" v-if="error.$validator == 'maxLength'"
                  >En fazla 15 karakter giriniz!</small
                >
              </template>
            </div>
            <div class="col-span-2">
              ...
              <template v-for="error in v$.password.$errors" :key="error.$uid">
                ...
                >
                <small class="text-red-600" v-if="error.$validator == 'minLength'"
                  >En az 8 karakter giriniz!</small
                >
                <small class="text-red-600" v-if="error.$validator == 'maxLength'"
                  >En fazla 20 karakter giriniz!</small
                >
              </template>
            </div>
            <div class="col-span-2">
              <label for="passwor2" class="block mb-2 text-sm font-medium text-gray-900"
                >Şifre Tekrar</label
              >
              <input
                type="password"
              ...
              <template v-for="error in v$.confirmPassword.$errors" :key="error.$uid">
                <small class="text-red-600" v-if="error.$validator == 'required'"
                  >Bu alan zorunlu</small
                >
                <small class="text-red-600" v-if="error.$validator == 'sameAs'"
                  >Lütfen parolanızın eşleştiğinden emin olunuz!</small
                >
              </template>
            </div>
        ...
        <template v-if="currentStep === 3">
          <RegisterEnd
            :message="registerSuccess ? 'Tebrikler' : 'Üzgünüz'"
            :message-detail="
              registerSuccess
                ? 'Kullanıcı kaydınız başarıyla oluşturulmuştur'
                : 'Kullanıcı kaydınız oluşturulamadı :('
            "
